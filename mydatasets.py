...
class MR(data.Dataset):
    ...
    def splits(cls, text_field, label_field, shuffle=True, **kwargs):
        example1 = cls(text_field, label_field, path='raw.clean.train', **kwargs).examples
        example2 = cls(text_field, label_field, path='raw.clean.dev', **kwargs).examples
        example3 = cls(text_field, label_field, path='raw.clean.test', **kwargs).examples
        if shuffle:
